...
Работа с Rmd-является R-центричной, так как нужен R-пакет `rmarkdown` для рендеринга документов.
...
::: callout-important
Этот блок для важных замечаний
:::

::: callout-caution
Этот блок для предупреждений
:::
...
Можно настроить очень много всего
...
Параметры для локализации [тут](https://quarto-meetup-begin.netlify.app/posts/day_2/)
...
-   При наличии проблем с кириллицей

## Применение в публикациях

Есть готовые форматы для ряда журналов, посмотреть можно [здесь](https://github.com/quarto-journals)

Очень удобно сделаны цитаты с возможностью подключать Zotero и загружать статьи с помощью doi.
...
У меня сайт блога и презентации тоже сделаны в [Quarto](https://ubogoeva.github.io/R4Analytics/).
